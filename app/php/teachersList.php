<?PHP
$data = array(
  array('sno' => 1, 'name' => "DHINAKARAN.M", 'img' =>"images/teachers/07_dhinakaran_m.jpg_medium.jpg", 'designation' => "Acting Principal", 'classes' => "VI-X", 'subject' => "SCIENCE", 'doj' => "5-6-2008"),
  array('sno' => 2, 'name' => "MEENA .M", 'img' =>"images/teachers/02_meena_m.jpg_medium.jpg", 'designation' => "Vice Principal", 'classes' => "VIII-X", 'subject' => "MATHS", 'doj' => "12-7-2003"),
  ...
  array('sno' => 4, 'name' => "POORNIMA.S", 'img' =>"images/teachers/15_poornima_s.jpg_medium.jpg", 'designation' => "COMP.TEACHER", 'classes' => "V-VIII", 'subject' => "COMPUTER", 'doj' => "10-6-2013"),
  array('sno' => 5, 'name' => "PUNITHA", 'img' =>"images/teachers/16_punitha.jpg_medium.jpg", 'designation' => "", 'classes' => "VI", 'subject' => "TAMIL", 'doj' => "1-7-2014"),
  array('sno' => 6, 'name' => "DEIVAKUMAR.S", 'img' =>"images/teachers/05_deivakumar_s.jpg_medium.jpg", 'designation' => "SEC. GRADE", 'classes' => "VI-VIII", 'subject' => "HISTORY", 'doj' => "3-6-2008"),
  ...
  array('sno' => 13, 'name' => "SAVITHA ", 'img' =>"images/teachers/savitha.jpg_medium.jpg", 'designation' => "SEC. GRADE", 'classes' => "IV", 'subject' => "XXX", 'doj' => "15-7-2014")
  );
